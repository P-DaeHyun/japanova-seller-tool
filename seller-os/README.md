...
1. **운영 대시보드** — 매출, 주문, 실제 순이익, 발주 필요 SKU, 연결상태
2. **주문·출고·라벨** — 주문 상태, 배송 옵션, 출고 처리, Tracking Number, PDF 라벨
3. **재고·발주** — 일본 실물재고, 안전재고, 목표재고, 발주 필요수량, 입고, 재고원장
4. **상품·원가** — Shopee 상품 동기화, 일본 매입원가, 포장비, SKU 연결
5. **실제 수익** — Escrow/수수료/배송비/실제 순이익
